$(document).ready(function() {
    $("#lotesCompositoTabla").jqGrid({
        ...
        colModel:[
            ...
            {name:'costoUnitarioTransporte',index:'costoUnitarioTransporte', width:45, hidden: true, align: "right",formatter:'number', formatoptions:{decimalSeparator: ".", thousandsSeparator: " ", decimalPlaces: 2, defaultValue: '0.00'}},
    ...
    function crearTablaComposito(){
        ...
        for(var i=0;i<mydata.length;i++){
            ...
            totalValorOficialBruto+=mydata[i].valorOficialBruto;
        ...
        $("#lotesCompositoTabla").jqGrid('footerData','set',{valorOficialBruto: toFixed(totalValorOficialBruto,2)});
