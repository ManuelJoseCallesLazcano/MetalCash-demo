...
$(document).ready(function() {
    ...
    function buscarFilas(){
        $.ajax({
            url: "/demo-liquidaciones/recepcionDeComplejo/recepcionGrupalZincPlataJSON",
            dataType: 'json',
            data: {
    ...
    function valorar(boton){
        ...
        if(lotesJSON[i].modoValoracion=="TERMINOS DE CONTRATO"){
            valorToneladaTerminos = valorToneladaPorTerminos(lotesJSON[i].recepcionId,lotesJSON[i].terminosDeContratoId,lotesJSON[i].porcentajeZincFinal,0,lotesJSON[i].porcentajePlataFinal,0);
    ...
    function liquidar(boton){
        ...
        if(confirm("Está seguro que desea liquidar el Lote "+lotesJSON[i].lote+"?")){
            ...
            $.ajax({
                url: "/demo-liquidaciones/liquidacionDeZincPlata/liquidar",
                async: false,
                dataType: 'json',
                data: {
...
//        });
        ...
        $('<form>', {
            ...
            "action": '/demo-liquidaciones/liquidacionDeZincPlata/crearReporteGrupal2'
