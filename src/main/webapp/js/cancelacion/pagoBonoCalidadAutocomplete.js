$(document).ready(function() {
    ...
    function cargarNumeroMesesPagables(){
        $.ajax({
            url: "/demo-liquidaciones/parametrosGenerales/mesesPagablesBonoCalidad",
            cache: false,
    ...
    function cargarLeyMinimaPlata(){
        $.ajax({
            url: "/demo-liquidaciones/parametrosGenerales/leyMinimaPlataBonoCalidad",
            cache: false,
            success: function(data) {
                $("#leyMinimaPlata").val(data.leyMinimaPlata);
            }
        });
    }
    ...
    function acumular(){
        $.ajax({
            url: "/demo-liquidaciones/pagoBonoCalidad/acumulacionPorMesJSON",
            dataType: 'json',
            data: {
                ...
                leyMinimaPlata: $('#leyMinimaPlata').val()
            },
            success: function(data) {
...
//            total+=mydata[i].costoDeTransporte;
        ...
        var totalPagable = cantidadAcumulada*tipoDeCambio*bonoPorTonelada/1000;
...
//            alert("fila: "+filas[i]);
    ...
    function nombreCobradorAutocomplete(){
        $("#ci").autocomplete({
            source: function(request, response){
                $.ajax({
                    url: "/demo-liquidaciones/pagoBonoCalidad/nombreCobradorJSON", // /demo-liquidaciones/recepcionDeComplejo/create
                    data: request,
                    success: function(data){
    ...
    $("#nombreCliente").autocomplete({
        source: function(request, response){
            $.ajax({
                url: "/demo-liquidaciones/pagoBonoCalidad/clientesPorNombreJSON", // /demo-liquidaciones/recepcionDeComplejo/create
                data: request,
                success: function(data){
                    response(data); // set the response
                },
