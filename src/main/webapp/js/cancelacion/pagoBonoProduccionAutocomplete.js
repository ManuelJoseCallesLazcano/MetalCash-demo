$(document).ready(function() {
    ...
    function cargarNumeroMesesPagables(){
        $.ajax({
            url: "/demo-liquidaciones/parametrosGenerales/mesesPagablesBonoProduccion",
            cache: false,
    ...
    function acumular(){
        $.ajax({
            url: "/demo-liquidaciones/pagoBonoProduccion/acumulacionPorMesJSON",
            dataType: 'json',
            data: {
...
//            alert("fila: "+filas[i]);
    ...
    function nombreCobradorAutocomplete(){
        $("#ci").autocomplete({
            source: function(request, response){
                $.ajax({
                    url: "/demo-liquidaciones/pagoBonoProduccion/nombreCobradorJSON", // /demo-liquidaciones/recepcionDeComplejo/create
                    data: request,
                    success: function(data){
    ...
    $("#nombreCliente").autocomplete({
        source: function(request, response){
            $.ajax({
                url: "/demo-liquidaciones/pagoBonoProduccion/clientesPorNombreJSON", // /demo-liquidaciones/recepcionDeComplejo/create
                data: request,
                success: function(data){
                    response(data); // set the response
                },
