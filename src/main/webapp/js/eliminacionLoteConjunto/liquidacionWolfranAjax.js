$(document).ready(function() {
    $("#lote").autocomplete({
        source: function(request, response){
            $.ajax({
                url: "/demo-liquidaciones/liquidacionDeWolfran/lotesEnConjuntoJSON", // /demo-liquidaciones/recepcionDeWolfran/create
                data: request,
        ...
        select: function(event, ui) { // event handler when user selects a company from the list.
            ...
            $('#conjuntoOriginal').val(ui.item.conjuntoWolfran);
        },
