$(document).ready(function() {
    $("#lote").autocomplete({
        source: function(request, response){
            $.ajax({
                url: "/demo-liquidaciones/liquidacionDeAntimonio/lotesEnConjuntoJSON", // /demo-liquidaciones/recepcionDeAntimonio/create
                data: request,
        ...
        select: function(event, ui) { // event handler when user selects a company from the list.
            ...
            $('#porcentajeAntimonio').val(ui.item.porcentajeAntimonio);
            $('#conjuntoOriginal').val(ui.item.conjuntoAntimonio);
        },
