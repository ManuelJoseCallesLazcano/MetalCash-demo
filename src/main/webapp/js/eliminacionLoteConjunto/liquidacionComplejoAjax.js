$(document).ready(function() {
    $("#lote").autocomplete({
        source: function(request, response){
            $.ajax({
                url: "/demo-liquidaciones/liquidacionDeComplejo/lotesEnConjuntoJSON", // /demo-liquidaciones/recepcionDeComplejo/create
                data: request,
        ...
        select: function(event, ui) { // event handler when user selects a company from the list.
            ...
            $('#conjuntoOriginal').val(ui.item.conjuntoComplejo);
        },
