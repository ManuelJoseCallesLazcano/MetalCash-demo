$(document).ready(function() {
    $("#lote").autocomplete({
        source: function(request, response){
            $.ajax({
                url: "/demo-liquidaciones/liquidacionDeEstano/lotesEnConjuntoJSON", // /demo-liquidaciones/recepcionDeEstano/create
                data: request,
        ...
        select: function(event, ui) { // event handler when user selects a company from the list.
            ...
            $('#porcentajeEstano').val(ui.item.porcentajeEstano);
            $('#conjuntoOriginal').val(ui.item.conjuntoEstano);
        },
