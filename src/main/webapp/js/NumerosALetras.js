/*
  ...
  Puede convertir un número entre una y ciento veintiseis cifras como máximo.
...
var CifrasEnLetras = {
  ...
  */
  ...
  /*
    ...
    Ejemplos: CifrasEnLetras.convertirDosCifras(22, "neutro") --> "veintidos"
  */
  ...
  /*
    ...
    Ejemplos: ifrasEnLetras.convertirTresCifras(222, "neutro") --> "doscientos veintidos"
  */
  ...
  /*
    Primer millon: del cero al novecientos noventa y nueve mil novecientos noventa y nueve.
    Ejemplo: CifrasEnLetras.convertirSeisCifras(222222, "neutro") --> "doscientos veintidos mil doscientos veintidos"
   */
  ...
  /*
    ...
    Ejemplos:
      CifrasEnLetras.convertirCifrasEnLetras("22222222") --> "veintidos millones doscientos veintidos mil doscientos veintidos"
      ...
      CifrasEnLetras.convertirCifrasEnLetras(10^6) --> "un millon"
      CifrasEnLetras.convertirCifrasEnLetras(10^12) --> "un billon"
      ...
      CifrasEnLetras.convertirCifrasEnLetras("1" + CifrasEnLetras.repetir('0',120)) --> "un vigillon"
  ...
  */
  ...
  /*
    ...
    - Los caracteres no numericos son ignorados.
    - Los múltiplos de millon tienen la preposicion "de" antes de la palabra.
    - El genero masculino o femenino solo puede influir en las cifras inferiores al millon

    Ejemplos:
      CifrasEnLetras.convertirNumeroEnLetras("-123,45",2) --> "menos ciento veintitres con cuarenta y cinco"
      CifrasEnLetras.convertirNumeroEnLetras("2.000,25", 3, "kilo",null,null, "gramo") --> "dos mil kilos con doscientos cincuenta gramos"
      CifrasEnLetras.convertirNumeroEnLetras("43,005", 3, "kilometro",null,null, "metro") --> "cuarenta y tres kilometros con cinco metros"
      CifrasEnLetras.convertirNumeroEnLetras("1.270,23", 2, "euro",null,null, "centimo") --> "mil doscientos setenta euros con veintitres centimos"
      CifrasEnLetras.convertirNumeroEnLetras("1", 2, "euro",null,null, "centimo") --> "un euro con cero centimos"
      CifrasEnLetras.convertirNumeroEnLetras("0,678", 2, "euro", null, null, "centimo") --> "cero euros con sesenta y siete centimos"
      CifrasEnLetras.convertirNumeroEnLetras("22.000,55", 0, "euro") --> "veintidos mil euros"
      ...
      CifrasEnLetras.convertirNumeroEnLetras("1,5", 2, "peseta",null,true, "centimo",null,false) --> "una peseta con cincuenta centimos"
      CifrasEnLetras.convertirNumeroEnLetras("300,56", 3, "segundo",null,false, "milesima",null,true) --> "trescientos segundos con quinientas sesenta milesimas"
      CifrasEnLetras.convertirNumeroEnLetras("21,21",2,"niño",null,false, "niña",null,true) --> "veintiún niños con veintiuna niñas"
      CifrasEnLetras.convertirNumeroEnLetras("1000000", null, "euro") --> "un millon de euros"
