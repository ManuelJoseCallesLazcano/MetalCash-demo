$(document).ready(function() {
    $("#toneladasMetricasHumedas,\n" +
        ...
        "#utilidadEstimada").keyup(function(){
        calcularProforma();
    });
    ...
    function calcularProforma(){
        ...
        var regaliaDiferenciaPlomo=transFloat($("#regaliaDiferenciaPlomo").val());
        var regaliaDiferenciaPlomoTotal=valorNetoTotal*regaliaDiferenciaPlomo/100;
        $("#regaliaDiferenciaPlomoTotal").val(isNaN(regaliaDiferenciaPlomoTotal)?"?":redondear2(regaliaDiferenciaPlomoTotal));

        var regaliaDiferenciaPlata=transFloat($("#regaliaDiferenciaPlata").val());
        var regaliaDiferenciaPlataTotal=valorNetoTotal*regaliaDiferenciaPlata/100;
        $("#regaliaDiferenciaPlataTotal").val(isNaN(regaliaDiferenciaPlataTotal)?"?":redondear2(regaliaDiferenciaPlataTotal));

        var pagosProvisionales=transFloat($("#pagosProvisionales").val());
        var pagosProvisionalesTotal=pagosProvisionales;
        $("#pagosProvisionalesTotal").val(isNaN(pagosProvisionalesTotal)?"?":redondear2(pagosProvisionalesTotal));

        var costoDescuento1=transFloat($("#costoDescuento1").val());
        var costoDescuento1Total=costoDescuento1;
        $("#costoDescuento1Total").val(isNaN(costoDescuento1Total)?"?":redondear2(costoDescuento1Total));

        var costoDescuento2=transFloat($("#costoDescuento2").val());
        var costoDescuento2Total=costoDescuento2;
        $("#costoDescuento2Total").val(isNaN(costoDescuento2Total)?"?":redondear2(costoDescuento2Total));

        var costoDescuento3=transFloat($("#costoDescuento3").val());
        var costoDescuento3Total=costoDescuento3;
        $("#costoDescuento3Total").val(isNaN(costoDescuento3Total)?"?":redondear2(costoDescuento3Total));

        var costoDescuento4=transFloat($("#costoDescuento4").val());
        var costoDescuento4Total=costoDescuento4;
        $("#costoDescuento4Total").val(isNaN(costoDescuento4Total)?"?":redondear2(costoDescuento4Total));

        var costoDescuento5=transFloat($("#costoDescuento5").val());
        var costoDescuento5Total=costoDescuento5;
        $("#costoDescuento5Total").val(isNaN(costoDescuento5Total)?"?":redondear2(costoDescuento5Total));

        var valorNetoTotalFinal=valorNetoTotal-();
        $("#valorNetoTotalFinal").val(isNaN(valorNetoTotalFinal)?"?":redondear2(valorNetoTotalFinal));

        var valorCompraMineral=transFloat($("#valorCompraMineral").val());
        var valorCompraMineralTotal=valorCompraMineral;
        $("#valorCompraMineralTotal").val(isNaN(valorCompraMineralTotal)?"?":redondear2(valorCompraMineralTotal));

        var utilidadEstimada=valorNetoTotalFinal-valorCompraMineralTotal;
        $("#utilidadEstimada").val(isNaN(utilidadEstimada)?"?":redondear2(utilidadEstimada));
    }
