...
<html>
	...
	<body>
		<a href="#create-reportePagoTransporte" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
			</ul>
		</div>
		<div id="create-reportePagoTransporte" class="content scaffold-create" role="main">
			<h1><g:message code="default.create.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${reportePagoTransporteInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${reportePagoTransporteInstance}" var="error">
            ...
            <fieldset class="form">
                ...
                <div class="fieldcontain ${hasErrors(bean: reportePagoTransporteInstance, field: 'elemento', 'error')} ">
                    ...
                    <g:select name="elemento" from="${['Estano','Plata','Wolfran','Antimonio','Complejo','Plomo Plata','Zinc Plata']}" value="${reportePagoTransporteInstance?.elemento}" valueMessagePrefix="reporteAnticiposContraEntrega.elemento" noSelection="['': '']"/>
                </div>

                <div id="_empresa" class="fieldcontain ${hasErrors(bean: reportePagoTransporteInstance, field: 'empresa', 'error')} " style="display: none">
                    <label for="empresa">
                ...
                <div id="_fechaInicial" class="fieldcontain ${hasErrors(bean: reportePagoTransporteInstance, field: 'fechaInicial', 'error')} required">
                    <label for="fechaInicial">
                        <g:message code="reporteAnticiposContraEntrega.fechaInicial.label" default="Fecha Inicial" />
                        <span class="required-indicator">*</span>
                    </label>
                    <g:datepickerUI name="fechaInicial" value="${reportePagoTransporteInstance?.fechaInicial ?: new Date()}"/>
                </div>

                <div id="_fechaFinal" class="fieldcontain ${hasErrors(bean: reportePagoTransporteInstance, field: 'fechaFinal', 'error')} required">
                    <label for="fechaFinal">
                        <g:message code="reporteAnticiposContraEntrega.fechaFinal.label" default="Fecha Final" />
                        <span class="required-indicator">*</span>
                    </label>
                    <g:datepickerUI name="fechaFinal" value="${reportePagoTransporteInstance?.fechaFinal ?: new Date()}"/>
                </div>

                <div id="_loteInicial" class="fieldcontain ${hasErrors(bean: reportePagoTransporteInstance, field: 'loteInicial', 'error')} " style="display: none">
                ...
                <div id="_loteFinal" class="fieldcontain ${hasErrors(bean: reportePagoTransporteInstance, field: 'loteFinal', 'error')} " style="display: none">
                    <label for="loteFinal">
