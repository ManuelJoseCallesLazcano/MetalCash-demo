...
<html>
	...
	<body>
		<a href="#edit-reporteLotesLiquidados" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteLotesLiquidados" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteLotesLiquidadosInstance?.version}" />
				<fieldset class="form">
