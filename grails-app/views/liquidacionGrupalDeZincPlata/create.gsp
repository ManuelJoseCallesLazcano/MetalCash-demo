...
<html>
	<head>
        ...
        <g:javascript src="liquidacionGrupalDeZincPlata/constructorTabla.js" />
	</head>
	<body>
		<a href="#create-liquidacionGrupalDeZincPlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
			</ul>
		</div>
		<div id="create-liquidacionGrupalDeZincPlata" class="content scaffold-create" role="main">
