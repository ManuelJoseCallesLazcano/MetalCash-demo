...
<html>
	...
	<body>
		<a href="#edit-reporteHistorialCliente" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteHistorialCliente" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteHistorialClienteInstance?.version}" />
				<fieldset class="form">
