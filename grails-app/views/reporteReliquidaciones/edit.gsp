...
<html>
	...
	<body>
		<a href="#edit-reporteReliquidaciones" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteReliquidaciones" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteReliquidacionesInstance?.version}" />
				<fieldset class="form">
