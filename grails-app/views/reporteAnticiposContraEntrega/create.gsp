...
<html>
	<head>
        ...
        <g:javascript src="reportes/anticiposContraEntrega.js" />
	</head>
	<body>
		<a href="#create-reporteAnticiposContraEntrega" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
			</ul>
		</div>
		<div id="create-reporteAnticiposContraEntrega" class="content scaffold-create" role="main">
			<h1><g:message code="default.create.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${reporteAnticiposContraEntregaInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${reporteAnticiposContraEntregaInstance}" var="error">
            ...
            <fieldset class="form">
                ...
                <div id="_empresa" class="fieldcontain ${hasErrors(bean: reporteAnticiposContraEntregaInstance, field: 'empresa', 'error')} " style="display: none">
                    <label for="empresa">
                ...
                <div id="_fechaInicial" class="fieldcontain ${hasErrors(bean: reporteAnticiposContraEntregaInstance, field: 'fechaInicial', 'error')} required">
                    <label for="fechaInicial">
                        <g:message code="reporteAnticiposContraEntrega.fechaInicial.label" default="Fecha Inicial" />
                        <span class="required-indicator">*</span>
                    </label>
                    <g:datepickerUI name="fechaInicial" value="${reporteAnticiposContraEntregaInstance?.fechaInicial ?: new Date()}"/>
                </div>

                <div id="_fechaFinal" class="fieldcontain ${hasErrors(bean: reporteAnticiposContraEntregaInstance, field: 'fechaFinal', 'error')} required">
                    <label for="fechaFinal">
                        <g:message code="reporteAnticiposContraEntrega.fechaFinal.label" default="Fecha Final" />
                        <span class="required-indicator">*</span>
                    </label>
                    <g:datepickerUI name="fechaFinal" value="${reporteAnticiposContraEntregaInstance?.fechaFinal ?: new Date()}"/>
                </div>

                <div id="_loteInicial" class="fieldcontain ${hasErrors(bean: reporteAnticiposContraEntregaInstance, field: 'loteInicial', 'error')} " style="display: none">
                ...
                <div id="_loteFinal" class="fieldcontain ${hasErrors(bean: reporteAnticiposContraEntregaInstance, field: 'loteFinal', 'error')} " style="display: none">
                    <label for="loteFinal">
                ...
                <div id="_ReportePorFechas">
                    <fieldset class="buttons">
                        <g:jasperReport controller="reporteAnticiposContraEntrega" action="crearReporte" jasper="reporte_anticipo_contra_entrega_fechas" format="PDF" name="ReporteAnticiposPorFechas">
                ...
                <div id="_ReportePorFechasEmpresa" style="display: none">
                    <fieldset class="buttons">
                        <g:jasperReport controller="reporteAnticiposContraEntrega" action="crearReporte" jasper="reporte_anticipo_contra_entrega_fechas_empresa" format="PDF" name="ReporteAnticiposPorFechasEmpresa">
                ...
                <div id="_ReportePorLotes" style="display: none">
                    <fieldset class="buttons">
                        <g:jasperReport controller="reporteAnticiposContraEntrega" action="crearReporte" jasper="reporte_anticipo_contra_entrega_lotes" format="PDF" name="ReporteAnticiposPorLotes">
                ...
                <div id="_ReportePorLotesEmpresa" style="display: none">
                    <fieldset class="buttons">
                        <g:jasperReport controller="reporteAnticiposContraEntrega" action="crearReporte" jasper="reporte_anticipo_contra_entrega_lotes_empresa" format="PDF" name="ReporteAnticiposPorLotesEmpresa">
