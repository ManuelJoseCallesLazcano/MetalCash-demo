...
<html>
	...
	<body>
		<a href="#edit-reporteGraficoCantidad" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteGraficoCantidad" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteGraficoCantidadInstance?.version}" />
				<fieldset class="form">
