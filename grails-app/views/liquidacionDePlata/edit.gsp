...
<html>
	<head>
        ...
        <g:javascript src="liquidacionDePlata/recepcionAutocomplete.js" />
        <g:javascript src="liquidacionDePlata/bonoCalidadAutocomplete.js" />
        <g:javascript src="liquidacionDePlata/bonoIncentivoAutocomplete.js" />
	...
	<body>
		<a href="#edit-liquidacionDePlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-liquidacionDePlata" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${liquidacionDePlataInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${liquidacionDePlataInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${liquidacionDePlataInstance?.version}" />
				<fieldset class="form">
