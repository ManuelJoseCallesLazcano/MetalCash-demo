...
<html>
	<head>
        ...
        <g:javascript src="calidad/recepcionCobrePlataAutocomplete.js" />
        <script>
	...
	<body>
		<a href="#edit-controlCalidadCobrePlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-controlCalidadCobrePlata" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${controlCalidadCobrePlataInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${controlCalidadCobrePlataInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${controlCalidadCobrePlataInstance?.version}" />
				<fieldset class="form">
