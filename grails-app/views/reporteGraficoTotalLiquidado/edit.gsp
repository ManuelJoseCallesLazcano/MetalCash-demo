...
<html>
	...
	<body>
		<a href="#edit-reporteGraficoTotalLiquidado" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteGraficoTotalLiquidado" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteGraficoTotalLiquidadoInstance?.version}" />
				<fieldset class="form">
