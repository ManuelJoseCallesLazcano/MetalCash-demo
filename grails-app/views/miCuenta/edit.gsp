...
<html>
	...
	<body>
		<a href="#edit-miCuenta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-miCuenta" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${miCuentaInstance?.version}" />
				<fieldset class="form">
