...
<div class="fieldcontain ${hasErrors(bean: proformaGeneralLiquidacionInstance, field: 'numeroProformaLiquidacion', 'error')} required" style="display:none;">
	<label for="numeroProformaLiquidacion">
		<g:message code="proformaGeneralLiquidacion.numeroProformaLiquidacion.label" default="Numero Proforma Liquidacion" />
		<span class="required-indicator">*</span>
	</label>
	<g:field name="numeroProformaLiquidacion" type="number" value="${proformaGeneralLiquidacionInstance.numeroProformaLiquidacion}" required="" inputmode="numeric"/>

</div>

<div class="fieldcontain ${hasErrors(bean: proformaGeneralLiquidacionInstance, field: 'fechaProformaLiquidacion', 'error')} required" style="display:none;">
	<label for="fechaProformaLiquidacion">
		<g:message code="proformaGeneralLiquidacion.fechaProformaLiquidacion.label" default="Fecha Proforma Liquidacion" />
		<span class="required-indicator">*</span>
	</label>
	<g:datePicker name="fechaProformaLiquidacion" precision="day"  value="${proformaGeneralLiquidacionInstance?.fechaProformaLiquidacion}"  />

</div>

<div class="fieldcontain ${hasErrors(bean: proformaGeneralLiquidacionInstance, field: 'nombreProforma', 'error')} required">
	<label for="nombreProforma">
		<g:message code="proformaGeneralLiquidacion.nombreProforma.label" default="Nombre Proforma" />
		<span class="required-indicator">*</span>
	</label>
	<g:textField name="nombreProforma" required="" value="${proformaGeneralLiquidacionInstance?.nombreProforma}" size="90"/>
