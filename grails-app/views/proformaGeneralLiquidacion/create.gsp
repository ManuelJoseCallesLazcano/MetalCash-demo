...
<html>
	...
	<body>
		<a href="#create-proformaGeneralLiquidacion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-proformaGeneralLiquidacion" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:proformaGeneralLiquidacionInstance, action:'save']" >
				<fieldset class="form">
