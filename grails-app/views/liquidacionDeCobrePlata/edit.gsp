...
<html>
	<head>
        ...
        <g:javascript src="liquidacionDeCobrePlata/recepcionAutocomplete.js" />
        <g:javascript src="liquidacionDeCobrePlata/bonoCalidadAutocomplete.js" />
        <g:javascript src="liquidacionDeCobrePlata/bonoIncentivoAutocomplete.js" />
        <script>
	...
	<body>
		<a href="#edit-liquidacionDeCobrePlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-liquidacionDeCobrePlata" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${liquidacionDeCobrePlataInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${liquidacionDeCobrePlataInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${liquidacionDeCobrePlataInstance?.version}" />
				<fieldset class="form">
