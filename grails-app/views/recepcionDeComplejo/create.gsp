...
%{--    <g:javascript src="chosen.jquery.js" />--}%
    ...
    <asset:javascript src="recepcionDeComplejo/recepcionComplejoUtilidades.js"/>
%{--    <g:javascript src="recepcionDeComplejo/choferAutocomplete.js" />--}%
%{--    <g:javascript src="recepcionDeComplejo/automovilAutocomplete.js" />--}%
%{--    <g:javascript src="recepcionDeComplejo/calculosRecepcion.js" />--}%
%{--    <g:javascript src="calculos/calculoCostoTransporte.js" />--}%
%{--    <g:javascript src="recepcionDeComplejo/recuperadorCotizacionDiaria.js" />--}%
    <script>
...
<div class="card card-primary">
    ...
    <g:form action="save">
        <div class="card-body">
            ...
            <g:hasErrors bean="${recepcionDeComplejoInstance}">
                <div id="swalErrorList" style="display:none">
                    <ul style="text-align:left; margin:0; padding-left:1.2em">
                        <g:eachError bean="${recepcionDeComplejoInstance}" var="error">
