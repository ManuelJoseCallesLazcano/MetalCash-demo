...
<html>
	...
	<body>
		<a href="#edit-tablaOrigenCotizacionesComplejo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-tablaOrigenCotizacionesComplejo" class="content scaffold-edit" role="main">
			...
			<g:form method="post"  enctype="multipart/form-data">
				...
				<g:hiddenField name="version" value="${tablaOrigenCotizacionesComplejoInstance?.version}" />
				<fieldset class="form">
