...
<html>
	...
	<body>
		<a href="#edit-tablaPreciosOro" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-tablaPreciosOro" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:tablaPreciosOroInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${tablaPreciosOroInstance?.version}" />
				<fieldset class="form">
