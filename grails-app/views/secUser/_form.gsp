...
<div class="fieldcontain ${hasErrors(bean: secUserInstance, field: 'deposito', 'error')} required">
	<label for="deposito">
		<g:message code="secUser.deposito.label" default="Deposito" />
		<span class="required-indicator">*</span>
	</label>
	<g:select id="deposito" name="deposito.id" from="${org.socymet.proveedor.Deposito.list()}" optionKey="id" required="" value="${secUserInstance?.deposito?.id}" class="many-to-one"/>

</div>

<div class="fieldcontain ${hasErrors(bean: secUserInstance, field: 'nombre', 'error')} required">
	<label for="nombre">
		<g:message code="secUser.nombre.label" default="Nombre" />
		<span class="required-indicator">*</span>
	</label>
	<g:textField name="nombre" required="" value="${secUserInstance?.nombre}"/>
