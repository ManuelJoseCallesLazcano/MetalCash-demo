...
<head>
    ...
    <title>Editar Análisis de Laboratorio</title>
...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">Editar Análisis de Laboratorio</h3>
    </div>
    <g:form method="post">
        <g:hiddenField name="id" value="${controlCalidadComplejoInstance?.id}" />
        <g:hiddenField name="version" value="${controlCalidadComplejoInstance?.version}" />
        <div class="card-body">
            ...
            <g:hasErrors bean="${controlCalidadComplejoInstance}">
                <div id="swalErrorList" style="display:none">
                    <ul style="text-align:left; margin:0; padding-left:1.2em">
                        <g:eachError bean="${controlCalidadComplejoInstance}" var="error">
