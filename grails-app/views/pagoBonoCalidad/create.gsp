...
<html>
	...
	<body>
		<a href="#create-pagoBonoCalidad" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-pagoBonoCalidad" class="content scaffold-create" role="main">
