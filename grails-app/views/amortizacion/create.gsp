...
<head>
    ...
    <title>Nueva Amortización</title>
    ...
    <asset:javascript src="amortizacion/amortizacionForm.js"/>
</head>
<body>
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Nueva Amortización</h3>
    </div>
    <g:form action="save" name="amortizacionForm">
        <div class="card-body">
...
<script>
    $(function () {
        $('#btnGuardar').on('click', function () {
            Swal.fire({
                title: '¿Registrar esta amortización?',
                html: 'Se registrará la amortización y reducirá la deuda del cliente en su estado de cuenta.',
                icon: 'question',
                ...
                if (result.isConfirmed) document.forms['amortizacionForm'].submit();
            });
        });
    });
</script>
