...
<html>
	...
	<body>
		<a href="#edit-reporteAnticipos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteAnticipos" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteAnticiposInstance?.version}" />
				<fieldset class="form">
