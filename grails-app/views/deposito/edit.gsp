    ...
    <g:form method="post">
        ...
        <div class="card-footer">
            ...
            <sec:ifAnyGranted roles="ROLE_ADMIN">
                <g:actionSubmit class="btn btn-danger ml-3" action="delete" value="Eliminar" formnovalidate=""
                    onclick="return confirm('¿Eliminar este depósito? Esta acción no se puede deshacer.');"/>
            </sec:ifAnyGranted>
        </div>
    </g:form>
</div>
