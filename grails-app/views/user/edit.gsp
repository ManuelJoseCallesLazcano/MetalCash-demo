...
<html>
	...
	<body>
		...
		<s2ui:form type='update' beanName='user' focus='nombre' class='button-style'>
			<s2ui:tabs elementId='tabs' height='375' data='${tabData}'>
				<s2ui:tab name='userinfo' height='275'>
					<table>
					<tbody>
						<s2ui:selectRow from="${org.socymet.proveedor.Deposito.list([sort: 'nombreDeposito'])}" name='deposito' labelCodeDefault='Deposito'/>
						<s2ui:textFieldRow name='nombre' labelCodeDefault='Nombre'/>
