...
<html>
	<head>
		...
		<g:javascript src="pagoDeRetenciones/filtroEmpresas.js" />
        <script>
	...
	<body>
		<a href="#create-pagoDeRetenciones" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-pagoDeRetenciones" class="content scaffold-create" role="main">
