...
<html>
	...
	<body>
		<a href="#edit-presupuestoLotesPorPagar" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-presupuestoLotesPorPagar" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${presupuestoLotesPorPagarInstance?.version}" />
				<fieldset class="form">
