...
<html>
	<head>
        ...
        <g:javascript src="anticipo/anticipoPorTransporte.js" />
		%{--<g:javascript src="pagoTransporte/filtroEmpresas.js" />--}%
	</head>
	<body>
		<a href="#create-anticipoPorTransporte" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-anticipoPorTransporte" class="content scaffold-create" role="main">
