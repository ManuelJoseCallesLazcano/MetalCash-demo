...
<head>
    ...
    <title>Nuevo Anticipo por Transporte</title>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Nuevo Anticipo por Transporte</h3>
    </div>
    <g:form action="save" name="anticipoForm">
        <div class="card-body">
    ...
    $(function () {
        $('#btnGuardar').on('click', function () {
            Swal.fire({
                ...
                html: 'Se registrará el anticipo y aumentará el saldo disponible para cobro en el pago de transporte para el automóvil.',
                icon: 'question',
                ...
                if (result.isConfirmed) document.forms['anticipoForm'].submit();
            });
        });
    });
</script>
