...
<html>
	...
	<body>
		<a href="#edit-reporteRetenciones" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteRetenciones" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteRetencionesInstance?.version}" />
				<fieldset class="form">
