...
<html>
	...
	<body>
		<a href="#create-reporteLotesAnalisis" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
%{--				<li><g:link class="list" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link></li>--}%
		...
		<div id="create-reporteLotesAnalisis" class="content scaffold-create" role="main">
...
%{--			<g:form url="[resource:reporteLotesAnalisisInstance, action:'save']" >--}%
			<g:form>
				<fieldset class="form">
