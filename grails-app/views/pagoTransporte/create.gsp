...
%{--		<g:javascript src="pagoTransporte/filtroEmpresas.js" />--}%
	...
	<body>
		<a href="#create-pagoTransporte" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-pagoTransporte" class="content scaffold-create" role="main">
