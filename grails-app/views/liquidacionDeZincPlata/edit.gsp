...
<html>
	<head>
        ...
        <g:javascript src="liquidacionDeZincPlata/recepcionAutocomplete.js" />
        <g:javascript src="liquidacionDeZincPlata/bonoCalidadAutocomplete.js" />
        <g:javascript src="liquidacionDeZincPlata/bonoIncentivoAutocomplete.js" />
        <script>
	...
	<body>
		<a href="#edit-liquidacionDeZincPlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-liquidacionDeZincPlata" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${liquidacionDeZincPlataInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${liquidacionDeZincPlataInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${liquidacionDeZincPlataInstance?.version}" />
