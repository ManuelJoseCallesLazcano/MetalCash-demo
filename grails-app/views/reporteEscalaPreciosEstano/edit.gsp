...
<html>
	...
	<body>
		<a href="#edit-reporteEscalaPreciosEstano" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteEscalaPreciosEstano" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteEscalaPreciosEstanoInstance?.version}" />
				<fieldset class="form">
