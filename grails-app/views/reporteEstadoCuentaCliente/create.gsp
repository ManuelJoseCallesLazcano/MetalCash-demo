...
<html>
	<head>
		...
		<g:javascript src="reportes/estadoCuentaClienteUtilidades.js" />
	</head>
	<body>
		<a href="#create-reporteEstadoCuentaCliente" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
%{--				<li><g:link class="list" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link></li>--}%
		...
		<div id="create-reporteEstadoCuentaCliente" class="content scaffold-create" role="main">
			...
			<g:form>
%{--			<g:form url="[resource:reporteEstadoCuentaClienteInstance, action:'save']" >--}%
				<fieldset class="form">
