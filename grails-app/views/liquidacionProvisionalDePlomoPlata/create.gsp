...
<html>
	<head>
        ...
        <g:javascript src="liquidacionProvisionalDePlomoPlata/recepcionAutocomplete.js" />
        <script>
	...
	<body>
		<a href="#create-liquidacionProvisionalDePlomoPlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-liquidacionProvisionalDePlomoPlata" class="content scaffold-create" role="main">
