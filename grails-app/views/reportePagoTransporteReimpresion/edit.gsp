...
<html>
	...
	<body>
		<a href="#edit-reportePagoTransporteReimpresion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reportePagoTransporteReimpresion" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reportePagoTransporteReimpresionInstance?.version}" />
				<fieldset class="form">
