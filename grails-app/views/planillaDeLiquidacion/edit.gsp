...
<html>
	...
	<body>
		<a href="#edit-planillaDeLiquidacion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-planillaDeLiquidacion" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${planillaDeLiquidacionInstance?.version}" />
				<fieldset class="form">
