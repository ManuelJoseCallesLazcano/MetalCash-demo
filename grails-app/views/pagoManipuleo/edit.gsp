...
<html>
	<head>
        ...
        <g:javascript src="cancelacion/pagoManipuleoAutocomplete.js" />
        <script>
	...
	<body>
		<a href="#edit-pagoManipuleo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-pagoManipuleo" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${pagoManipuleoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${pagoManipuleoInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${pagoManipuleoInstance?.version}" />
				<fieldset class="form">
