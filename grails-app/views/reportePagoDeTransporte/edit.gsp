...
<html>
	...
	<body>
		<a href="#edit-reportePagoDeTransporte" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reportePagoDeTransporte" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reportePagoDeTransporteInstance?.version}" />
				<fieldset class="form">
