...
<div class="card card-secondary">
    <div class="card-header d-flex align-items-center">
        <h3 class="card-title">Cotización Quincenal de Minerales</h3>
        <div class="ml-auto">
    ...
    <div class="card-body p-0">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-striped mb-0">
                ...
                <tbody>
                <g:each in="${cotizacionQuincenalDeMineralesInstanceList}" var="inst">
                    <tr>
                ...
                <g:if test="${!cotizacionQuincenalDeMineralesInstanceList}">
                    <tr>
    ...
    <div class="card-footer">
        <g:paginate total="${cotizacionQuincenalDeMineralesInstanceTotal ?: 0}"/>
    </div>
</div>
</body>
</html>
