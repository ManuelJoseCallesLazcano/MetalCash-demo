...
<head>
    ...
    <title>Nuevo Anticipo Contra Futura Entrega</title>
    ...
    <asset:javascript src="anticipoContraFuturaEntrega/anticipoContraFuturaEntregaForm.js"/>
</head>
<body>
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Nuevo Anticipo Contra Futura Entrega</h3>
    </div>
    <g:form action="save" name="acfeForm">
        <div class="card-body">
            ...
            <g:hasErrors bean="${anticipoContraFuturaEntregaInstance}">
                <div id="swalErrorList" style="display:none">
                    <ul style="text-align:left; margin:0; padding-left:1.2em">
                        <g:eachError bean="${anticipoContraFuturaEntregaInstance}" var="error">
...
<script>
    $(function () {
        $('#btnGuardar').on('click', function () {
            Swal.fire({
                title: '¿Registrar este anticipo?',
                html: 'Se registrará el anticipo y afectará el estado de cuenta del cliente.',
                icon: 'question',
                ...
                if (result.isConfirmed) document.forms['acfeForm'].submit();
            });
        });
    });
</script>
