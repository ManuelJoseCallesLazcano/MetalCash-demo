...
<html>
	...
	<body>
		<a href="#edit-reporteDetalleAnticiposContraEntrega" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteDetalleAnticiposContraEntrega" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteDetalleAnticiposContraEntregaInstance?.version}" />
				<fieldset class="form">
