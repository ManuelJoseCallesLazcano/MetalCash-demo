...
<html>
	...
	<body>
		<a href="#edit-reporteDetalleLotesDadosDeBaja" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteDetalleLotesDadosDeBaja" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteDetalleLotesDadosDeBajaInstance?.version}" />
				<fieldset class="form">
