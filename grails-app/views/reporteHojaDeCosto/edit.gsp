...
<html>
	...
	<body>
		<a href="#edit-reporteHojaDeCosto" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteHojaDeCosto" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteHojaDeCostoInstance?.version}" />
				<fieldset class="form">
