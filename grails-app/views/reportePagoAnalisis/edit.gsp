...
<html>
	...
	<body>
		<a href="#edit-reportePagoAnalisis" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reportePagoAnalisis" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reportePagoAnalisisInstance?.version}" />
				<fieldset class="form">
