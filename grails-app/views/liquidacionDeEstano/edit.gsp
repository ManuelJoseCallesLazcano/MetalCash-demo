...
<html>
	<head>
        ...
        <g:javascript src="liquidacionDeEstano/recepcionAutocomplete.js" />
        <g:javascript src="liquidacionDeEstano/bonoCalidadAutocomplete.js" />
        <g:javascript src="liquidacionDeEstano/bonoIncentivoAutocomplete.js" />
	...
	<body>
		<a href="#edit-liquidacionDeEstano" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-liquidacionDeEstano" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${liquidacionDeEstanoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${liquidacionDeEstanoInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${liquidacionDeEstanoInstance?.version}" />
				<fieldset class="form">
