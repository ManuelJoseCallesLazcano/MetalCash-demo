...
<html>
	<head>
		...
		<g:javascript src="cancelacion/cierreCajaUtilidades.js" />
	</head>
	<body>
		<a href="#create-cierreCaja" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-cierreCaja" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:cierreCajaInstance, action:'save']" >
				<fieldset class="form">
