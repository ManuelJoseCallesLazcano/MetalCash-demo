		...
		<div id="list-cuenta" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="codigoCuenta" title="${message(code: 'cuenta.codigoCuenta.label', default: 'Codigo Cuenta')}" />
				...
				<g:each in="${cuentaInstanceList}" status="i" var="cuentaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${cuentaInstance.id}">${fieldValue(bean: cuentaInstance, field: "codigoCuenta")}</g:link></td>
