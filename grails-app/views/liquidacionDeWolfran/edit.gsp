...
<html>
	<head>
        ...
        <g:javascript src="liquidacionDeWolfran/recepcionAutocomplete.js" />
        <g:javascript src="liquidacionDeWolfran/bonoCalidadAutocomplete.js" />
        <g:javascript src="liquidacionDeWolfran/bonoIncentivoAutocomplete.js" />
	...
	<body>
		<a href="#edit-liquidacionDeWolfran" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-liquidacionDeWolfran" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${liquidacionDeWolfranInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${liquidacionDeWolfranInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${liquidacionDeWolfranInstance?.version}" />
				<fieldset class="form">
