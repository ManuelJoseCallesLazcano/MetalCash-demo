...
<html>
	...
	<body>
		<a href="#edit-reporteLotesRecepcionados" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteLotesRecepcionados" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteLotesRecepcionadosInstance?.version}" />
				<fieldset class="form">
