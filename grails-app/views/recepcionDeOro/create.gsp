...
<html>
	<head>
		...
		%{--<g:javascript src="recepcionDeComplejo/recuperadorTransporteUltimoRegistro.js" />--}%
		<script>
	...
	<body>
		<a href="#create-recepcionDeOro" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-recepcionDeOro" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:recepcionDeOroInstance, action:'save']" >
				<fieldset class="form">
