...
<html>
	...
	<body>
		<a href="#edit-reporteEscalaPreciosPlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-reporteEscalaPreciosPlata" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${reporteEscalaPreciosPlataInstance?.version}" />
				<fieldset class="form">
