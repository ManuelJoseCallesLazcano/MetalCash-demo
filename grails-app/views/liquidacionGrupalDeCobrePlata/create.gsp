...
<html>
	<head>
        ...
        <g:javascript src="liquidacionGrupalDeCobrePlata/constructorTabla.js" />
	</head>
	<body>
		<a href="#create-liquidacionGrupalDeCobrePlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
			</ul>
		</div>
		<div id="create-liquidacionGrupalDeCobrePlata" class="content scaffold-create" role="main">
