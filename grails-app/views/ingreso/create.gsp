...
<html>
	<head>
		...
		<g:javascript src="ingreso/ingresoUtilidades.js" />
	</head>
	<body>
		<a href="#create-ingreso" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-ingreso" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:ingresoInstance, action:'save']" >
				<fieldset class="form">
