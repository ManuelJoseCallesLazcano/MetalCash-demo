...
<html>
	...
	<body>
		<a href="#edit-liquidacionGrupalDePlomoPlata" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-liquidacionGrupalDePlomoPlata" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${liquidacionGrupalDePlomoPlataInstance?.version}" />
				<fieldset class="form">
