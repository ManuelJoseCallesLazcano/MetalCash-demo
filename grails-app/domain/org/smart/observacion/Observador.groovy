 ...
 * under the License.
*/
package org.smart.observacion

/**
 * Observadors are reported to the AuditLog table.
 * This requires you to set up a table or allow
 * Grails to create a table for you. (e.g. DDL or db-migration plugin)
 */
class Observador implements Serializable {
    ...
    static mapping = {
        ...
        version false
        autoTimestamp false  // el plugin gestiona dateCreated/lastUpdated directamente
    }
