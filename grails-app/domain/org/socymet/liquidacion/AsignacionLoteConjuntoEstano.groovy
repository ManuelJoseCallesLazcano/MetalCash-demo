...
class AsignacionLoteConjuntoEstano {
    ...
    def afterInsert = {
        def liquidacionDeEstano = LiquidacionDeEstano.get(liquidacionId)
        liquidacionDeEstano.conjuntoEstano=conjuntoDestino
        liquidacionDeEstano.save(failOnError: true)

        def reimpresion = new Reimpresion(fecha: new java.util.Date(),
        nombreReporte: "ASIGNACION DE LOTE A CONJUNTO DE ESTANO",
