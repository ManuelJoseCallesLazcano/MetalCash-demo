...
class LiquidacionDeZincPlata extends Liquidacion{
    static searchable = true

    Integer numeroLiquidacionZincPlata //e.g.: GENERADO: 1, PARA MOSTRAR: 0001
    String conjuntoZincPlata
    ...
    static constraints = {
        numeroLiquidacionZincPlata(nullable: true)
        conjuntoZincPlata(blank: true)
    ...
    def beforeInsert = {
        def c = LiquidacionDeZincPlata.createCriteria()
        def results = c {
            projections {
                max('numeroLiquidacionZincPlata')
            }}
        def maxNumeroLiquidacion = results.get(0)?: 0
        this.numeroLiquidacionZincPlata = maxNumeroLiquidacion + 1
        this.conjuntoZincPlata = "-"
    ...
    def afterInsert = {
        ...
        LiquidacionDeZincPlata.withNewTransaction {
            def liquidacionDeZincPlata = LiquidacionDeZincPlata.get(this.id)
            ...
            retencionesJSON.each {
                ...
                if(!codigo.equals("-")){
                    def liquidacionDeZincPlataRetenciones = new LiquidacionDeZincPlataRetenciones(
                            ...
                            monto: monto)
                    liquidacionDeZincPlataRetenciones.save(failOnError: true)

                    def retencionPorPagarComplejo = new RetencionPorPagarComplejo(
                            liquidacionId: liquidacionDeZincPlata.id,
                            codigo: codigo,
                            cantidadDescuento: cantidad,
                            unidadDeDescuento: unidad,
                            tipoDeRetencion: tipo,
                            ...
                            asignacionDelDescuento: asignacion,
                            monto: monto,
                            lote: liquidacionDeZincPlata.recepcionDeComplejo.toString(),
                            kilosNetosSecos: liquidacionDeZincPlata.kilosNetosSecos,
                            valorOficialNeto: liquidacionDeZincPlata.valorNetoMineralEnBolivianos,
                            recepcionDeComplejo: liquidacionDeZincPlata.recepcionDeComplejo,
                            tipoDeMineral: liquidacionDeZincPlata.recepcionDeComplejo.tipoDeMineral,
                            empresa: liquidacionDeZincPlata.empresa,
//                            fechaDeRegistro: liquidacionDeZincPlata.fechaDeLiquidacion,
                            fechaDeRegistro: liquidacionDeZincPlata.recepcionDeComplejo.fechaDeRecepcion,
                            pagado: "NO"
                    )
    ...
    def afterUpdate = {
        ...
        def retencionesAnteriores = LiquidacionDeZincPlataRetenciones.findAllByLiquidacionDeZincPlata(this)
...
//                            fechaDeRegistro: liquidacionDeZincPlata.fechaDeLiquidacion,
        ...
        */
        ...
        def reimpresion = new Reimpresion(
                ...
                identificadorDocumento: numeroLiquidacionZincPlata,
                lote: lote,
