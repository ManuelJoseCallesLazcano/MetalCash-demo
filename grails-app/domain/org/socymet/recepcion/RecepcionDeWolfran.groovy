...
class RecepcionDeWolfran extends Recepcion{
    static searchable = true

    Integer loteWolfran //e.g.: GENERADO: 1, PARA MOSTRAR: SB000001
    ...
    String toString(){
        ...
        "${decimalFormat.format(loteWolfran)}"
    }
}
