...
class BajaDeRecepcionDePlomoPlata {
    String lote
    ...
    def afterInsert = {
        ...
        def recepcionAnterior = RecepcionDePlomoPlata.get(recepcionId)
        ...
        if(tipoDeBaja.equals("Baja por transferencia")){
            ...
            def nuevaRecepcion = RecepcionDePlomoPlata.get(recepcionDestinoId)
