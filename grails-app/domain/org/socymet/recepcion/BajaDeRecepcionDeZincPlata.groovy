...
class BajaDeRecepcionDeZincPlata {
    String lote
    ...
    def afterInsert = {
        ...
        def recepcionAnterior = RecepcionDeZincPlata.get(recepcionId)
        ...
        if(tipoDeBaja.equals("Baja por transferencia")){
            ...
            def nuevaRecepcion = RecepcionDeZincPlata.get(recepcionDestinoId)
