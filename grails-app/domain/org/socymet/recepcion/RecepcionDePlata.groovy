...
class RecepcionDePlata extends Recepcion {
    static searchable = true

    Integer lotePlata //e.g.: GENERADO: 1, PARA MOSTRAR: SB000001
    ...
    String toString(){
        ...
        "${decimalFormat.format(lotePlata)}"
    }
}
