...
class RecepcionDeZincPlata extends Recepcion{
    static searchable = true

    Integer loteZincPlata //e.g.: GENERADO: 1, PARA MOSTRAR: SB000001
    ...
    String toString(){
        ...
        "${decimalFormat.format(loteZincPlata)}"
    }
}
