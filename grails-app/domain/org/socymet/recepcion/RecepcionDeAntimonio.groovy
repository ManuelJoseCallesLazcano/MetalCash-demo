...
class RecepcionDeAntimonio extends Recepcion{
    static searchable = true

    Integer loteAntimonio //e.g.: GENERADO: 1, PARA MOSTRAR: SB000001
    ...
    String toString(){
        ...
        "${decimalFormat.format(loteAntimonio)}"
    }
}
