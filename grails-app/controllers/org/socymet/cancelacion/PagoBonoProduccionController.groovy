...
@Transactional
class PagoBonoProduccionController {
    ...
    def list(Integer max) {
        ...
        [pagoBonoProduccionInstanceList: PagoBonoProduccion.list(params), pagoBonoProduccionInstanceTotal: PagoBonoProduccion.count()]
    }

    def create() {
        [pagoBonoProduccionInstance: new PagoBonoProduccion(params)]
    }

    def save() {
        def pagoBonoProduccionInstance = new PagoBonoProduccion(params)
        if (!pagoBonoProduccionInstance.save(flush: true)) {
            render(view: "create", model: [pagoBonoProduccionInstance: pagoBonoProduccionInstance])
            return
        }

        flash.message = message(code: 'default.created.message', args: [message(code: 'pagoBonoProduccion.label', default: 'PagoBonoProduccion'), pagoBonoProduccionInstance.id])
        redirect(action: "show", id: pagoBonoProduccionInstance.id)
    }

    def show(Long id) {
        def pagoBonoProduccionInstance = PagoBonoProduccion.get(id)
        if (!pagoBonoProduccionInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'pagoBonoProduccion.label', default: 'PagoBonoProduccion'), id])
            redirect(action: "list")
            return
        }

        [pagoBonoProduccionInstance: pagoBonoProduccionInstance]
    }
    ...
    def update(Long id, Long version) {
        ...
        if (version != null) {
            if (pagoBonoProduccionInstance.version > version) {
                pagoBonoProduccionInstance.errors.rejectValue("version", "default.optimistic.locking.failure",
                        [message(code: 'pagoBonoProduccion.label', default: 'PagoBonoProduccion')] as Object[],
                        "Another user has updated this PagoBonoProduccion while you were editing")
                render(view: "edit", model: [pagoBonoProduccionInstance: pagoBonoProduccionInstance])
                return
            }
        }

        pagoBonoProduccionInstance.properties = params
        ...
        flash.message = message(code: 'default.updated.message', args: [message(code: 'pagoBonoProduccion.label', default: 'PagoBonoProduccion'), pagoBonoProduccionInstance.id])
        redirect(action: "show", id: pagoBonoProduccionInstance.id)
    }
    ...
    def delete(Long id) {
        ...
        try {
            pagoBonoProduccionInstance.delete(flush: true)
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'pagoBonoProduccion.label', default: 'PagoBonoProduccion'), id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'pagoBonoProduccion.label', default: 'PagoBonoProduccion'), id])
    ...
    def acumulacionPorMesJSON() {
        ...
        if (tipoSeleccion.equals("INDIVIDUAL")&&!params.clienteId.toString().equals("null")){
            ...
            liquidacionesComplejo = LiquidacionDeComplejo.findAllByFechaDeLiquidacionBetweenAndEmpresa(fechaInicial,fechaFinal,empresa)
            liquidacionesPlomoPlata = LiquidacionDePlomoPlata.findAllByFechaDeLiquidacionBetweenAndEmpresa(fechaInicial,fechaFinal,empresa)
            liquidacionesZincPlata = LiquidacionDeZincPlata.findAllByFechaDeLiquidacionBetweenAndEmpresa(fechaInicial,fechaFinal,empresa)
            liquidacionesCobrePlata = LiquidacionDeCobrePlata.findAllByFechaDeLiquidacionBetweenAndEmpresa(fechaInicial,fechaFinal,empresa)
