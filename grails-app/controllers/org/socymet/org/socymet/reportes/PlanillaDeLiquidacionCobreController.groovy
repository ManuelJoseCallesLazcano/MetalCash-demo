...
import org.socymet.liquidacion.LiquidacionDeCobrePlataRetenciones
import org.socymet.proveedor.Empresa
import org.springframework.dao.DataIntegrityViolationException

@Transactional
class PlanillaDeLiquidacionCobreController {
    ...
    def list(Integer max) {
        ...
        [planillaDeLiquidacionCobreInstanceList: PlanillaDeLiquidacionCobre.list(params), planillaDeLiquidacionCobreInstanceTotal: PlanillaDeLiquidacionCobre.count()]
    }

    def create() {
        [planillaDeLiquidacionCobreInstance: new PlanillaDeLiquidacionCobre(params)]
    }

    def save() {
        def planillaDeLiquidacionCobreInstance = new PlanillaDeLiquidacionCobre(params)
        if (!planillaDeLiquidacionCobreInstance.save(flush: true)) {
            render(view: "create", model: [planillaDeLiquidacionCobreInstance: planillaDeLiquidacionCobreInstance])
            return
        }

        flash.message = message(code: 'default.created.message', args: [message(code: 'planillaDeLiquidacionCobre.label', default: 'PlanillaDeLiquidacionCobre'), planillaDeLiquidacionCobreInstance.id])
        redirect(action: "show", id: planillaDeLiquidacionCobreInstance.id)
    }

    def show(Long id) {
        def planillaDeLiquidacionCobreInstance = PlanillaDeLiquidacionCobre.get(id)
        if (!planillaDeLiquidacionCobreInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'planillaDeLiquidacionCobre.label', default: 'PlanillaDeLiquidacionCobre'), id])
            redirect(action: "list")
            return
        }

        [planillaDeLiquidacionCobreInstance: planillaDeLiquidacionCobreInstance]
    }
    ...
    def update(Long id, Long version) {
        ...
        if (version != null) {
            if (planillaDeLiquidacionCobreInstance.version > version) {
                planillaDeLiquidacionCobreInstance.errors.rejectValue("version", "default.optimistic.locking.failure",
                        [message(code: 'planillaDeLiquidacionCobre.label', default: 'PlanillaDeLiquidacionCobre')] as Object[],
                        "Another user has updated this PlanillaDeLiquidacionCobre while you were editing")
                render(view: "edit", model: [planillaDeLiquidacionCobreInstance: planillaDeLiquidacionCobreInstance])
                return
            }
        }

        planillaDeLiquidacionCobreInstance.properties = params
        ...
        flash.message = message(code: 'default.updated.message', args: [message(code: 'planillaDeLiquidacionCobre.label', default: 'PlanillaDeLiquidacionCobre'), planillaDeLiquidacionCobreInstance.id])
        redirect(action: "show", id: planillaDeLiquidacionCobreInstance.id)
    }
    ...
    def delete(Long id) {
        ...
        try {
            planillaDeLiquidacionCobreInstance.delete(flush: true)
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'planillaDeLiquidacionCobre.label', default: 'PlanillaDeLiquidacionCobre'), id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'planillaDeLiquidacionCobre.label', default: 'PlanillaDeLiquidacionCobre'), id])
...
//        def tipoReporte = ""+params.tipoReporte
        ...
        if (tipoReporte.equals("fechasEmpresa")){
            ...
            def liquidacionesCuAg = LiquidacionDeCobrePlata.list([sort: 'lote'])
            ...
            System.out.println("*** RESULTADOS DE CobrePlata: ${liquidacionesCobrePlata.size()}")
        }
        ...
        sheet1.addCell(new Label(21,6, "LEY %Cu",formatoEncabezado))
        ...
        sheet1.addCell(new Label(28,6, "K. F. Cu",formatoEncabezado))
        ...
        sheet1.addCell(new Label(35,6, "COT. OF. Cu",formatoEncabezado))
        ...
        sheet1.addCell(new Label(42,6, "ALIC. Cu %",formatoEncabezado))
        ...
        if(liquidacionesCobrePlata){
            ...
            def totalKilosFinosPlomoCobrePlata=0
            ...
            liquidacionesCobrePlata.each {
                ...
                totalKilosFinosPlomoCobrePlata+=it.kilosFinosCobre
                ...
                sheet1.addCell(new Number(21,fila, it.porcentajeCobreFinal,formatoDatos)) //ZN
                ...
                sheet1.addCell(new Number(28,fila, it.kilosFinosCobre,formatoDatos)) //ZN
                ...
                sheet1.addCell(new Number(35,fila, it.recepcionDeComplejo.cotizacionQuincenalDeMinerales.cobre,formatoDatos)) //ZN
                ...
                sheet1.addCell(new Number(42,fila, it.recepcionDeComplejo.alicuota.cobre,formatoDatos)) //ZN
