...
import org.socymet.cotizaciones.TablaCotizacionAntimonioController
import org.springframework.dao.DataIntegrityViolationException

@Transactional
class ReporteEscalaPreciosAntimonioController {
    ...
    def list(Integer max) {
        ...
        [reporteEscalaPreciosAntimonioInstanceList: ReporteEscalaPreciosAntimonio.list(params), reporteEscalaPreciosAntimonioInstanceTotal: ReporteEscalaPreciosAntimonio.count()]
    }

    def create() {
        [reporteEscalaPreciosAntimonioInstance: new ReporteEscalaPreciosAntimonio(params)]
    }

    def save() {
        def reporteEscalaPreciosAntimonioInstance = new ReporteEscalaPreciosAntimonio(params)
        if (!reporteEscalaPreciosAntimonioInstance.save(flush: true)) {
            render(view: "create", model: [reporteEscalaPreciosAntimonioInstance: reporteEscalaPreciosAntimonioInstance])
            return
        }

        flash.message = message(code: 'default.created.message', args: [message(code: 'reporteEscalaPreciosAntimonio.label', default: 'ReporteEscalaPreciosAntimonio'), reporteEscalaPreciosAntimonioInstance.id])
        redirect(action: "show", id: reporteEscalaPreciosAntimonioInstance.id)
    }

    def show(Long id) {
        def reporteEscalaPreciosAntimonioInstance = ReporteEscalaPreciosAntimonio.get(id)
        if (!reporteEscalaPreciosAntimonioInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'reporteEscalaPreciosAntimonio.label', default: 'ReporteEscalaPreciosAntimonio'), id])
            redirect(action: "list")
            return
        }

        [reporteEscalaPreciosAntimonioInstance: reporteEscalaPreciosAntimonioInstance]
    }
    ...
    def update(Long id, Long version) {
        ...
        if (version != null) {
            if (reporteEscalaPreciosAntimonioInstance.version > version) {
                reporteEscalaPreciosAntimonioInstance.errors.rejectValue("version", "default.optimistic.locking.failure",
                        [message(code: 'reporteEscalaPreciosAntimonio.label', default: 'ReporteEscalaPreciosAntimonio')] as Object[],
                        "Another user has updated this ReporteEscalaPreciosAntimonio while you were editing")
                render(view: "edit", model: [reporteEscalaPreciosAntimonioInstance: reporteEscalaPreciosAntimonioInstance])
                return
            }
        }

        reporteEscalaPreciosAntimonioInstance.properties = params
        ...
        flash.message = message(code: 'default.updated.message', args: [message(code: 'reporteEscalaPreciosAntimonio.label', default: 'ReporteEscalaPreciosAntimonio'), reporteEscalaPreciosAntimonioInstance.id])
        redirect(action: "show", id: reporteEscalaPreciosAntimonioInstance.id)
    }
    ...
    def delete(Long id) {
        ...
        try {
            reporteEscalaPreciosAntimonioInstance.delete(flush: true)
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'reporteEscalaPreciosAntimonio.label', default: 'ReporteEscalaPreciosAntimonio'), id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'reporteEscalaPreciosAntimonio.label', default: 'ReporteEscalaPreciosAntimonio'), id])
            redirect(action: "show", id: id)
        }
    }

    def crearReporteEscalaPreciosAntimonio = {
        ...
        def tablaCotizacionAntimonio = ""+params.tablaCotizacionAntimonio.id

        if (params.tablaCotizacionAntimonio.id=="null") {
            flash.error = "No ha seleccionado la Tabla de Cotizacion de Antimonio"
        ...
        sheet.addCell(new Label(0,1, "ESCALA DE PRECIOS DE ANTIMONIO",formatoEncabezado))
        sheet.addCell(new Label(4,1, "ESCALA DE PRECIOS DE ANTIMONIO",formatoEncabezado))
        sheet.addCell(new Label(8,1, "ESCALA DE PRECIOS DE ANTIMONIO",formatoEncabezado))
        sheet.addCell(new Label(0,18, "ESCALA DE PRECIOS DE ANTIMONIO",formatoEncabezado))
        sheet.addCell(new Label(4,18, "ESCALA DE PRECIOS DE ANTIMONIO",formatoEncabezado))
        sheet.addCell(new Label(8,18, "ESCALA DE PRECIOS DE ANTIMONIO",formatoEncabezado))
        ...
        /*sheet.addCell(new Label(0,2, "COTIZACION: ${cotizacionAntimonio}".replace('.',','),formatoEncabezado))
        sheet.addCell(new Label(4,2, "COTIZACION: ${cotizacionAntimonio}".replace('.',','),formatoEncabezado))
        sheet.addCell(new Label(8,2, "COTIZACION: ${cotizacionAntimonio}".replace('.',','),formatoEncabezado))
        sheet.addCell(new Label(0,19, "COTIZACION: ${cotizacionAntimonio}".replace('.',','),formatoEncabezado))
        sheet.addCell(new Label(4,19, "COTIZACION: ${cotizacionAntimonio}".replace('.',','),formatoEncabezado))
        sheet.addCell(new Label(8,19, "COTIZACION: ${cotizacionAntimonio}".replace('.',','),formatoEncabezado))*/

        sheet.addCell(new Label(0,3, "Sb%",formatoEncabezado))
        ...
        sheet.addCell(new Label(4,3, "Sb%",formatoEncabezado))
        ...
        sheet.addCell(new Label(8,3, "Sb%",formatoEncabezado))
        ...
        sheet.addCell(new Label(0,20, "Sb%",formatoEncabezado))
        ...
        sheet.addCell(new Label(4,20, "Sb%",formatoEncabezado))
        ...
        sheet.addCell(new Label(8,20, "Sb%",formatoEncabezado))
        ...
        def tablaCotizacionAntimonioController = new TablaCotizacionAntimonioController()
        def leyes = [10.0,15.0,20.0,25.0,30.0,35.0,40.0,50.0,60.0,70.0]
        def fila = 0

        tablaCotizacionAntimonio = Integer.parseInt(tablaCotizacionAntimonio)

        leyes.each {
            def vpt = tablaCotizacionAntimonioController.getValorPorToneladaPresupuesto(tablaCotizacionAntimonio,it)

            vpt = Float.parseFloat("${vpt}")
