...
class DepositoController {
    ...
    def list(Integer max) {
        ...
        if (q) {
            def pattern = "%${q}%"
            [depositoInstanceList : Deposito.findAllByNombreDepositoIlikeOrCodigoDepositoIlikeOrDireccionIlike(pattern, pattern, pattern, params),
             depositoInstanceTotal: Deposito.countByNombreDepositoIlikeOrCodigoDepositoIlikeOrDireccionIlike(pattern, pattern, pattern)]
        } else {
    ...
    def save() {
        ...
        flash.message = message(code: 'default.created.message', args: [message(code: 'deposito.label', default: 'Deposito'), depositoInstance.toString()])
    ...
    def update(Long id, Long version) {
        ...
        flash.message = message(code: 'default.updated.message', args: [message(code: 'deposito.label', default: 'Deposito'), depositoInstance.toString()])
        redirect(action: "show", id: depositoInstance.id)
    }
    ...
    def delete(Long id) {
        ...
        try {
            def nombreDeposito = depositoInstance.toString()
...
//            flash.message = message(code: 'default.deleted.message', args: [message(code: 'deposito.label', default: 'Deposito'), id])
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'deposito.label', default: 'Deposito'), nombreDeposito])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'deposito.label', default: 'Deposito'), depositoInstance.nombreDeposito])
